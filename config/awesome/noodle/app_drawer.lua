...
local function create_button(symbol, color, hover_color, cmd, text)
...
-- Create app buttons
local browser = create_button("", beautiful.xcolor3, beautiful.xcolor11, browser_command, "Firefox")
local discord = create_button("", beautiful.xcolor5, beautiful.xcolor13, discord_command, "Discord")
local telegram = create_button("", beautiful.xcolor4, beautiful.xcolor12, telegram_command, "Telegram")
local mail = create_button("", beautiful.xcolor6, beautiful.xcolor14, mail_command, "Mail")
local files = create_button("", beautiful.xcolor3, beautiful.xcolor11, file_manager_command, "Files")
local gimp = create_button("", beautiful.xcolor5, beautiful.xcolor13, gimp_command, "Gimp")
local youtube = create_button("", beautiful.xcolor1, beautiful.xcolor9, youtube_command, "Youtube")
local networks = create_button("", beautiful.xcolor3, beautiful.xcolor11, networks_command, "Network")
local passwords = create_button("", beautiful.xcolor1, beautiful.xcolor9, passwords_command, "Passwords")
local night_mode = create_button("", beautiful.xcolor1, beautiful.xcolor9, night_mode_command, "Nightmode")
local record = create_button("", beautiful.xcolor4, beautiful.xcolor12, record_command, "Record")
local lutris = create_button("", beautiful.xcolor6, beautiful.xcolor14, lutris_command, "Lutris")
local steam = create_button("", beautiful.xcolor2, beautiful.xcolor10, steam_command, "Steam")
local org = create_button("", beautiful.xcolor2, beautiful.xcolor10, org_command, "Org")
local performance = create_button("", beautiful.xcolor5, beautiful.xcolor13, performance_mode_command, "Performance")

local restart_awesome = create_button("", beautiful.xcolor4, beautiful.xcolor12, nil, "Restart")
